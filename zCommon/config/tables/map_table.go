...
type MapTableLoader struct {
	...
	spawnPoints    map[int32]*models.MapSpawnPoint    // 刷新点配置映射
	teleportPoints map[int32]*models.MapTeleportPoint // 传送点配置映射
	buildings      map[int32]*models.MapBuilding      // 建筑配置映射
...
// GetSpawnPointsByMapID ���ݵ�ͼID��ȡ���ɵ�
...
// GetTeleportPointsByMapID ���ݵ�ͼID��ȡ���͵�
